...
/**
 * Spacer between cards: same width/borders as container, with 24 vertical
 * grid lines and equal gaps. Not a semantic section.
 */
export default function CardGap({ className = "", height = "h-20" }: CardGapProps) {
  ...
  return (
    <div
      ref={containerRef}
      aria-hidden="true"
      className={`max-w-7xl mx-auto border-b border-border ${height} w-full overflow-hidden bg-background ${className}`}
    >
      <canvas
        ref={canvasRef}
